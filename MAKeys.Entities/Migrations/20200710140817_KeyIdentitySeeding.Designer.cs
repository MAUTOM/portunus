...
namespace MAKeys.Entities.Migrations
{
    ...
    [Migration("20200710140817_KeyIdentitySeeding")]
    partial class KeyIdentitySeeding
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAKeys.Entities.Models.KeyIdentity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("KeyIdentities");

                    b.HasData(
                        new
                        {
                            Id = -1L,
                            CreationDate = new DateTime(2020, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            Id = -2L,
                            CreationDate = new DateTime(2020, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("MAKeys.Entities.Models.PublicKey", b =>
                {
...
",
            ...
            modelBuilder.Entity("MAKeys.Entities.Models.KeyIdentity", b =>
                {
                    b.HasOne("MAKeys.Entities.Models.PublicKey", "PublicKey")
