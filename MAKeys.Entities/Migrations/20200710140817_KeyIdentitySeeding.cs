...
namespace MAKeys.Entities.Migrations
{
    public partial class KeyIdentitySeeding : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArmoredKey = table.Column<string>(nullable: false),
                    SubmissionDate = table.Column<DateTime>(nullable: false, defaultValueSql: "now()"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicKeys", x => x.Fingerprint);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false),
                    PublicKeyFingerprint = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeyIdentities", x => x.IdentityId);
                    table.ForeignKey(
                        name: "FK_KeyIdentities_PublicKeys_PublicKeyFingerprint",
                        column: x => x.PublicKeyFingerprint,
            ...
            migrationBuilder.InsertData(
                table: "PublicKeys",
                columns: new[] { "Fingerprint", "Algorithm", "ArmoredKey", "CreationDate", "ExpirationDate", "Length" },
...
", new DateTime(2020, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2021, 6, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 4096 });
            ...
            migrationBuilder.InsertData(
                table: "KeyIdentities",
                columns: new[] { "IdentityId", "Comment", "CreationDate", "Email", "Name", "PublicKeyFingerprint" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeyIdentities_PublicKeyFingerprint",
                table: "KeyIdentities",
